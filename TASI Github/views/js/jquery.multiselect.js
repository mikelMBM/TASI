...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div class="ms-options-wrap"><button type="button" id="filterbutton"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
            //$(instance.element).after('<div class="ms-options-wrap"><button type="button" id="' + idangabe + '"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
        ...
        if( (options === undefined) || (typeof options === 'object') ) {
            ...
            this.each(function(){
                ...
                if( instance instanceof MultiSelect && typeof instance[ options ] === 'function' ) {
                    retu = instance[ options ].apply( instance, Array.prototype.slice.call( args, 1 ) );
                }
